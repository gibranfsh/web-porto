...
const ProjectSection = () => {
  ...
  return (
    <section ref={sectionRef} className="pt-12 pb-12 sm:pt-16 sm:pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-gray-950/30 to-transparent relative overflow-hidden scroll-mt-[var(--nav-height)]" id="projects">
