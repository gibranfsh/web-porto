...
import { AcademicCapIcon, BriefcaseIcon, ArrowDownIcon } from "@heroicons/react/24/solid";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-8 items-center">
        ...
        >
          ...
          <h1 className="font-extrabold text-white text-4xl sm:text-5xl lg:text-6xl mb-6 leading-tight">
            ...
            <div className="relative h-[1.5em] w-full overflow-visible">
          ...
          <p className="text-gray-300 text-base sm:text-lg lg:text-xl mb-8 max-w-2xl">
            ...
            grow professionally person. I specialize in building robust web applications 
            with modern technologies and delivering seamless user experiences.
          </p>
          ...
          <div className="space-y-3 mb-8">
            <div className="w-full flex flex-row items-center justify-start sm:justify-start">
              <div className="bg-red-600/20 p-2 rounded-full mr-3 flex-none">
                <BriefcaseIcon className="h-5 w-5 text-red-500" />
              </div>
              <span className="text-white text-sm sm:text-base">
                <span className="font-bold relative px-2 py-1 rounded bg-gradient-to-r from-red-900 to-red-800">
                  <span className="relative z-10">ACTIVELY LOOKING FOR A JOB!</span>
                ...
                </span> - Ready to rock your team and make your company massively grow!
              </span>
            </div>
